                    ...
                    <DialogContent>
                      ...
                      <div className="space-y-4 py-4">
                        <div>
                          ...
                          <Input type="text" placeholder="Ex: 50000" value={goalForm.revenue_goal} onChange={(e) => setGoalForm({ ...goalForm, revenue_goal: e.target.value })} />
                        </div>
                        <div>
                          <Label>Meta de NPS (quantidade)</Label>
                          <Input type="number" placeholder="Ex: 10" value={goalForm.nps_goal} onChange={(e) => setGoalForm({ ...goalForm, nps_goal: e.target.value })} />
                        </div>
                        <div>
                          <Label>Meta de Depoimentos (quantidade)</Label>
                          <Input type="number" placeholder="Ex: 5" value={goalForm.testimonials_goal} onChange={(e) => setGoalForm({ ...goalForm, testimonials_goal: e.target.value })} />
                        </div>
                        <div>
                          <Label>Meta de Indicações (quantidade)</Label>
                          <Input type="number" placeholder="Ex: 8" value={goalForm.referrals_goal} onChange={(e) => setGoalForm({ ...goalForm, referrals_goal: e.target.value })} />
                        </div>
