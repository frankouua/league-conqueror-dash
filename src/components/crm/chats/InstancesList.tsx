...
const instanceDisplayConfig: Record<string, { name: string; badge: string; badgeColor: string }> = {
  ...
  'VIVI_CS': { name: 'Vivi', badge: 'Customer Success', badgeColor: 'bg-teal-500 text-white' },
  ...
  'PAULA_CS': { name: 'Paula', badge: 'Customer Success', badgeColor: 'bg-teal-500 text-white' },
