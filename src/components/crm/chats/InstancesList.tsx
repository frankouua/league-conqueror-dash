...
const instanceDisplayConfig: Record<string, { name: string; badge: string; badgeColor: string }> = {
  ...
  'VIVI_CS': { name: 'Vivi', badge: 'Customer Success', badgeColor: 'bg-teal-600 text-white' },
  'BIANCA_CLOSER': { name: 'Bianca', badge: 'Closer', badgeColor: 'bg-red-500 text-white' },
  'KAMYLLE_FARMER': { name: 'Kamylle', badge: 'Farmer', badgeColor: 'bg-purple-500 text-white' },
  'LARISSA_CLOSER': { name: 'Larissa', badge: 'Closer', badgeColor: 'bg-red-500 text-white' },
  'RODRIGO_SOCIAL': { name: 'Rodrigo', badge: 'Social Selling', badgeColor: 'bg-pink-500 text-white' },
  'PAULA_CS': { name: 'Paula', badge: 'Customer Success', badgeColor: 'bg-teal-600 text-white' },
